<template>
  ...
  <q-input :model-value="modelValue" type="number" :label="title" :min="16" :max="32767" :readonly="disable"
  ...
  <q-btn-group outline>
    <q-btn outline dense color="secondary" v-for="size in sizes" :key="size" :disable="disable"
