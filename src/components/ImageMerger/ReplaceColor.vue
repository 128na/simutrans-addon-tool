...
const rgb = computed({
  get: () => {
    const [r, g, b] = [
      props.modelValue.search.r.toString(16).padStart(2, '0'),
      props.modelValue.search.g.toString(16).padStart(2, '0'),
      props.modelValue.search.b.toString(16).padStart(2, '0'),
    ];
...
const rgba = computed({
  get: () => {
    const [r, g, b, a] = [
      props.modelValue.replace.r.toString(16).padStart(2, '0'),
      props.modelValue.replace.g.toString(16).padStart(2, '0'),
      props.modelValue.replace.b.toString(16).padStart(2, '0'),
      props.modelValue.replace.a.toString(16).padStart(2, '0'),
    ];
